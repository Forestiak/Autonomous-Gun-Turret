...
def distance(x,y,):
    ...
    targrange=math.sqrt(((360-xtarget)**2)+((360-ytarget)**2))
   ...
   # frameSmall=cv2.resize(img,(0,0),fx=scale,fy=scale)
    ...
    for pose in poses:
        ...
        if rect_img.any() != False:
            ...
            if pi==True or pi==pf: #if the person is priority or the objective isnt
